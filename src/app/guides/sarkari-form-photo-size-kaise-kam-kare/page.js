...
export default function SarkariFormPhotoSizeGuide() {
  ...
  const faqs = [
    {
      question: 'सरकारी फॉर्म के लिए फोटो कितने KB की होनी चाहिए?',
      answer: 'यह form या application की official requirement पर निर्भर करता है। आमतौर पर 20KB, 50KB या 100KB की लिमिट होती है, लेकिन हमेशा official notification चेक करें।'
    },
    {
      question: 'क्या मोबाइल से फोटो का size कम कर सकते हैं?',
      answer: 'हाँ, Shivashutosh Labs के सभी photo size tools मोबाइल-फ्रेंडली हैं। आप अपने मोबाइल ब्राउज़र से सीधे फोटो अपलोड करके साइज कम कर सकते हैं।'
    },
    {
      question: '20KB और 50KB में कौन सा tool इस्तेमाल करें?',
      answer: 'यह इस बात पर निर्भर करता है कि आपके फॉर्म में maximum file size कितना मांगा गया है। अगर फॉर्म में max 50KB लिखा है, तो Photo 50KB टूल का उपयोग करें। अगर max 20KB है, तो Photo 20KB टूल चुनें।'
    },
    {
      question: 'फोटो का KB कम करने से quality खराब होगी?',
      answer: 'फाइल साइज बहुत ज्यादा कम करने पर (जैसे 5MB से 20KB) थोड़ी quality कम हो सकती है, लेकिन हमारे टूल्स स्मार्ट कंप्रेशन का उपयोग करते हैं जिससे फोटो धुंधली न हो और फॉर्म में आसानी से accept हो जाए।'
    },
    {
      question: 'फोटो का KB कम करने के साथ size/dimensions भी बदल सकते हैं?',
      answer: 'हाँ, अगर फॉर्म में विशेष dimensions (जैसे 132x170 pixels) मांगे गए हैं, तो KB कम करने से पहले हमारे Resize Image टूल का उपयोग करके डायमेंशन बदल सकते हैं।'
    }
  ];
